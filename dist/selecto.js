...
(function (global, factory) {
    ...
    */
    ...
    var PROPERTIES = ["selectableTargets", "selectByClick", "selectFromInside", "continueSelect", "toggleContinueSelect", "keyContainer", "hitRate", "scrollOptions", "checkInput", "preventDefault", "ratio", "scale"];
    /**
     * @memberof Selecto
     */
    ...
    function (_super) {
      ...
      __proto.check = function (e) {
        ...
        this.target.style.cssText += "display: block;" + "left:0px;top:0px;" + ("transform: translate(" + left * scale + "px, " + top * scale + "px);") + ("width:" + width * scale + "px;height:" + height * scale + "px;");
